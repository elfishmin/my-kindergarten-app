...
import pandas as pd
from datetime import datetime  # 關鍵：確保這行存在
import requests
import json
import time
...
all_data = {
    ...
    "星期四": {
        ...
        "直排輪": [("冰淇淋", "吳承浚"), ("冰淇淋", "吳姷樼"), ("冰淇淋", "宋宥希"), ("冰淇淋", "范芯瑀"), ("彩虹魚", "徐郁蓁"), ("粉蠟筆", "陳愷蒂"), ("粉蠟筆", "劉選項"), ("粉蠟筆", "鐘苡禎"), ("藍天使", "周星宇"), ("綠格子", "張哲銘"), ("紫葡萄", "吳尚恩"), ("紫葡萄", "林予煖")]
    },
    "星期五": {
